...
#include <coral/EvictingCacheMap.h>
#include <mutex>
 ...
 */
typedef coral::EvictingCacheMap<std::string, SSL_SESSION*> SSLSessionCacheMap;
...
typedef std::pair<coral::AsyncSSLSocket *,
                  std::unique_ptr<coral::DelayedDestruction::DestructorGuard>>
  AttachedLookup;
